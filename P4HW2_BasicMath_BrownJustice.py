...
#If user enters a number not listed in the options: Display an error messeage 
# and prompt the user to choose a menu option
...
if selection == 1:
    ...
    print('This is an incorrect menu opterion, please try again.')
    number1 = int(input("Enter your first number."))
number2 = int(input("Enter you second number."))
